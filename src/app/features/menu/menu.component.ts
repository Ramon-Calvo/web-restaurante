...
export class MenuComponent {
  ...
  filteredItems = computed(() => {
    ...
    // Si hay búsqueda, buscar en TODOS los productos (ignorar categoría)
    if (query) {
      ...
      // Si NO hay búsqueda pero SÍ hay categoría, filtrar por categoría
  ...
  onSearch(): void {
    // La búsqueda ya es reactiva, este método se mantiene por si se necesita
    // pero la búsqueda se actualiza automáticamente con searchInput
  }
