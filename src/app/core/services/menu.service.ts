  ...
  loadMenu(): void {
    ...
    const mockMenu: MenuItem[] = [
      ...
      },
      {
        id: '3',
        name: 'Plato Kebab',
        description: 'Plato combinado con carne de kebab, acompañamiento a elegir y ensalada',
        price: 9.50,
        category: MenuCategory.PLATO,
        image: 'https://www.gourmetkebab.es/wp-content/uploads/2022/04/receta-kebab-con-arroz.jpg',
        available: true,
        ingredients: ['Carne kebab', 'Arroz o Patatas', 'Ensalada'],
        spicyLevel: 1,
        customizations: [
          {
            id: 'carne',
          ...
          },
          {
            ...
            maxSelections: 1,
            options: [
              { id: 'patatas', name: 'Patatas fritas', price: 0 },
